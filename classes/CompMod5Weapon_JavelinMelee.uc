class CompMod5Weapon_JavelinMelee extends AOCWeapon_JavelinMelee;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_Javelin'
    ...
    bCanDodge=false
    AlternativeMode=class'CompMod5Weapon_JavelinThrow'
