class CompMod5FamilyInfo_Mason_Knight extends AOCFamilyInfo_Mason_Knight;
...
DefaultProperties
{
    ...
    NewPrimaryWeapons(6)=(CWeapon=class'CompMod5Weapon_Longsword')
    ...
    NewSecondaryWeapons(3)=(CWeapon=class'CompMod5Weapon_Broadsword')
