class CompMod5Weapon_Longsword extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_Longsword'
    ...
    AlternativeMode=class'CompMod5Weapon_Longsword1H'
