class CompMod5Weapon_Longsword1H extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_Longsword1H'
    ...
    AlternativeMode=class'CompMod5Weapon_Longsword'
