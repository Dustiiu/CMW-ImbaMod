class CompMod5Weapon_Crossbow extends CompMod5RangeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_Crossbow'
    ...
    WeaponProjectiles(0)=class'CompMod5Proj_SteelBolt'
