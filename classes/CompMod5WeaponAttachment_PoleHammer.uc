class CompMod5WeaponAttachment_PoleHammer extends AOCWeaponAttachment_PoleHammer;
...
DefaultProperties
{
    ...
    WeaponClass=class'CompMod5Weapon_PoleHammer'
    ...
    AttackTypeInfo(1)=(fBaseDamage=105, fForce=32000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
