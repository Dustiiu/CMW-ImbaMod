class CompMod5WeaponAttachment_Dane extends AOCWeaponAttachment_Dane;
...
DefaultProperties
{
    ...
    WeaponClass=class'CompMod5Weapon_Dane'

    WeaponSocket = wep1hpoint

    AttackTypeInfo(0)=(fBaseDamage=70.0, fForce=22500, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
    AttackTypeInfo(1)=(fBaseDamage=70.0, fForce=25000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
