class CompMod5CTFPlayerController extends AOCCTFPlayerController
    dependson(CompMod5CTF);

`include(CompMod5/Include/CompMod5CTF.uci)
`include(CompMod5/Include/CompMod5PlayerController.uci)
