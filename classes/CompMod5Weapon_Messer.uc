class CompMod5Weapon_Messer extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_Messer'
    ...
    AlternativeMode=class'CompMod5Weapon_Messer1H'
    ...
    ReleaseAnimations(0)=(AnimationName=3p_longsword_slash01release,ComboAnimation=3p_longsword_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.messer_attack_01',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.575,fBlendInTime=0.0,fBlendOutTime=0.0,bLastAnimation=false)
