class CompMod5Weapon_SwordOfWar1H extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_SwordOfWar1H'
    ...
    AlternativeMode=class'CompMod5Weapon_SwordOfWar'
