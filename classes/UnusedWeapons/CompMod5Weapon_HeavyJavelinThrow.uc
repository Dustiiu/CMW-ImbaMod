class CompMod5Weapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_HeavyJavelinThrow'
    ...
    AlternativeMode=class'CompMod5Weapon_HeavyJavelinMelee'
