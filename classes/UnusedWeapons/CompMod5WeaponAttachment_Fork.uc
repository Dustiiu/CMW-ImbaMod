class CompMod5WeaponAttachment_Fork extends AOCWeaponAttachment_Fork;
...
DefaultProperties
{
    ...
    WeaponID=EWEP_Fork
    WeaponClass=class'CompMod5Weapon_Fork'
    WeaponSocket=wep2hpoint
    bUseAlternativeKick=true

    AttackTypeInfo(0)=(fBaseDamage=20.0, fForce=35000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
