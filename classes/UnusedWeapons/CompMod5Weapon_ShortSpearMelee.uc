class CompMod5Weapon_ShortSpearMelee extends AOCWeapon_ShortSpearMelee;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_ShortSpear'
    ...
    bCanDodge=false
    AlternativeMode=class'CompMod5Weapon_ShortSpearThrow'
