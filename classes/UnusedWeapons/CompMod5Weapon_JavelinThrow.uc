class CompMod5Weapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_JavelinThrow'
    ...
    AlternativeMode=class'CompMod5Weapon_JavelinMelee'
