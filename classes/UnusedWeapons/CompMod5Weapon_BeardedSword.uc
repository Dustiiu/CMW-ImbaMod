class CompMod5Weapon_BeardedSword extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_BeardedSword'
    ...
    AlternativeMode=class'CompMod5Weapon_Bearded'
