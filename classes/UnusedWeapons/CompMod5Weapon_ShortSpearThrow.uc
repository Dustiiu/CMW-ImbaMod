class CompMod5Weapon_ShortSpearThrow extends AOCWeapon_ShortSpearThrow;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_ShortSpearThrow'
    ...
    AlternativeMode=class'CompMod5Weapon_ShortSpearMelee'
