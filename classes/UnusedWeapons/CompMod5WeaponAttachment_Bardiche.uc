class CompMod5WeaponAttachment_Bardiche extends AOCWeaponAttachment_Bardiche;
...
DefaultProperties
{
    ...
    WeaponClass=class'CompMod5Weapon_Bardiche'
    WeaponSocket=wepPolepoint

    WeaponStaticMeshScale=1

    AttackTypeInfo(0)=(fBaseDamage=80.0, fForce=33500, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
    AttackTypeInfo(1)=(fBaseDamage=100.0, fForce=34500, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
