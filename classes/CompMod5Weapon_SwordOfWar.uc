class CompMod5Weapon_SwordOfWar extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    AttachmentClass=class'CompMod5WeaponAttachment_SwordOfWar'
    ...
    AlternativeMode=class'CompMod5Weapon_SwordOfWar1H'
    ...
    WindupAnimations(1)=(AnimationName=3p_longsword_slash02downtoup,ComboAnimation=3p_longsword_slash021downtoup,AlternateAnimation=3p_longsword_slash021altdowntoup,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.545,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
