class CompMod5RangeWeapon extends AOCRangeWeapon;
...
simulated function ChangeProjectileType(class<AOCProjectile> Proj) {
    ...
    if (class<CompMod5Weapon_Crossbow>(Class) != none && AOCOwner.PawnInfo.myTertiary == class'AOCWeapon_ExtraAmmo')
...
simulated state Active {
    simulated function BeginFire(byte FireModeNum) {
        ...
        else if (bLoaded || (FireModeNum == Attack_Overhead && CompMod5Weapon_Crossbow(self) != none))
