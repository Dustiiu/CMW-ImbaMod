class CompMod5Weapon_PoleAxe extends CompMod5MeleeWeapon;
...
DefaultProperties
{
    ...
    bTwoHander=true
    FlinchTime2H=1.0
    AttachmentClass=class'CompMod5WeaponAttachment_PoleAxe'
    ...
    ReleaseAnimations(1)=(AnimationName=3p_doubleaxe_slash02release,ComboAnimation=3p_doubleaxe_slash021release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.doubleaxe_Attack_02',bFullBody=True,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.5,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
