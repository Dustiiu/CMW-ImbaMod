class CompMod5WeaponAttachment_Claymore extends AOCWeaponAttachment_Claymore;
...
DefaultProperties
{
    ...
    WeaponClass=class'CompMod5Weapon_Claymore'
    WeaponSocket=wep2hpoint

    bUseAlternativeKick=true

    AttackTypeInfo(0)=(fBaseDamage=60.0, fForce=32000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
    AttackTypeInfo(1)=(fBaseDamage=75.0, fForce=32000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
