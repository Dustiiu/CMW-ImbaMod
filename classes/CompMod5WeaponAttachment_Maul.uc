class CompMod5WeaponAttachment_Maul extends AOCWeaponAttachment_Maul;
...
DefaultProperties
{
    ...
    WeaponID=EWEP_Maul
    WeaponClass=class'CompMod5Weapon_Maul'
    ...
    AttackTypeInfo(2)=(fBaseDamage=40.0, fForce=40000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
