class CompMod5WeaponAttachment_Halberd extends AOCWeaponAttachment_Halberd;
...
DefaultProperties
{
    ...
    WeaponClass=class'CompMod5Weapon_Halberd'
    ...
    AttackTypeInfo(1)=(fBaseDamage=80.0, fForce=30000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
