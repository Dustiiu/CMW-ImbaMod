class CompMod5FamilyInfo_Agatha_Vanguard extends AOCFamilyInfo_Agatha_Vanguard;
...
DefaultProperties
{
    ...
    NewPrimaryWeapons(3)=(CWeapon=class'CompMod5Weapon_Spear',CorrespondingDuelProp=EDUEL_SpearUse)
    ...
    NewPrimaryWeapons(8)=(CWeapon=class'CompMod5Weapon_Halberd',CorrespondingDuelProp=EDUEL_HalberdUse)
    ...
    NewSecondaryWeapons(5)=(CWeapon=class'CompMod5Weapon_Dane',CorrespondingDuelProp=EDUEL_DaneUse)
    NewSecondaryWeapons(6)=(CWeapon=class'CompMod5Weapon_Broadsword')
