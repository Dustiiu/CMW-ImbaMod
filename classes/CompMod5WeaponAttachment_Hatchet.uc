class CompMod5WeaponAttachment_Hatchet extends AOCWeaponAttachment_Hatchet;
...
DefaultProperties
{
    ...
    WeaponClass=class'CompMod5Weapon_Hatchet'

    WeaponSocket = wep1hpoint

    AttackTypeInfo(0)=(fBaseDamage=70.0, fForce=20000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
    AttackTypeInfo(1)=(fBaseDamage=75.0, fForce=20000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
